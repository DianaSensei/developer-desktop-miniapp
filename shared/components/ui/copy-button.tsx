...
// Vendored copy for externally-installed plugins (see shared/README.md): the
// original reads `editor.copyFeedbackMs` from `AppConfigContext`, which is
// shell-only and unreachable from a plugin bundle. Hard-code the app's own
// default (1500ms) instead of wiring up `usePluginConfig()` here — it's a
// cosmetic timing, not worth a vendor-bridge entry.
