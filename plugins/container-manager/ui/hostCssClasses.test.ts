...
/** Verified to be written by at least one file under the host app's `src/**`. */
const ALLOWED = new Set([
  'w-[5px]', 'w-[3px]', 'w-[104px]', 'w-[110px]',
  'left-[2px]', 'left-[1px]',
  'min-w-[180px]', 'min-h-[16px]',
  'grid-cols-[1fr_auto]',
]);
...
describe('plugin classes the host stylesheet may not contain', () => {
  ...
  it('recognises the class the log dialog regressed on', () => {
